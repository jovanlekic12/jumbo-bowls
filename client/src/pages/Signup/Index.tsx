...
function SignUp() {
  return (
    <div className="flex font-poppins items-center justify-center h-screen cursor-alias">
      <div style={{ width: "100%", height: "1080px", position: "relative" }}>
        <Waves
          ...
          yGap={36}
        />
        <div className="gap-8 flex items-center justify-center h-screen">
          <div
            id="back-div"
            className="w-md z-20 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-[26px] m-4"
          >
